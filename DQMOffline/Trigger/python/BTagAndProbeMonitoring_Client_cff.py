...
BTagAndProbe_elejets = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/EleJet/*"),
...
BTagAndProbe_singleMu = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/SingleLepton/SingleMuon/*"),
    verbose        = cms.untracked.uint32(0),                                                                                                        
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_met       'efficiency vs MET;MET [GeV];efficiency' met_numerator       met_denominator",
...
BTagAndProbe_diElec = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/DiLepton/DiElectron/*"),
    verbose        = cms.untracked.uint32(0),                                      
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_met       'efficiency vs MET;MET [GeV];efficiency' met_numerator       met_denominator",
...
BTagAndProbe_diMu = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/DiLepton/DiMuon/*"),
    verbose        = cms.untracked.uint32(0),                                      
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_met       'efficiency vs MET;MET [GeV];efficiency' met_numerator       met_denominator",
...
BTagAndProbe_ElecMu = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/DiLepton/ElecMuon/*"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_met       'efficiency vs MET;MET [GeV];efficiency' met_numerator       met_denominator",
...
BTagAndProbe_fullyhadronic_Reference = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/FullyHadronic/Reference/*"),
    verbose        = cms.untracked.uint32(0), 
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_eventHT       'efficiency vs event H_{T};event H_{T} [GeV];efficiency' eventHT_numerator       eventHT_denominator",
...
BTagAndProbe_fullyhadronic_DoubleBTag = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/FullyHadronic/DoubleBTag/*"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
...
BTagAndProbe_fullyhadronic_SingleBTag = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/FullyHadronic/SingleBTag/*"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_jetPt_1       'efficiency vs 1st jet p_{T};jet p_{T} [GeV];efficiency' jetPt_1_numerator       jetPt_1_denominator",
...
BTagAndProbe_fullyhadronic_TripleBTag = DQMEDHarvester("DQMGenericClient", #FIXME
    subDirs        = cms.untracked.vstring("HLT/BTV/FullyHadronic/TripleBTag/*"),
    verbose        = cms.untracked.uint32(0),
    resolution     = cms.vstring(),
    efficiency     = cms.vstring(
        "effic_jetPt_1       'efficiency vs 1st jet p_{T};jet p_{T} [GeV];efficiency' jetPt_1_numerator       jetPt_1_denominator",
